...
183	Miami	DST	t
184	T.J. Yeldon	RB	t
185	Austin Ekeler	RB	t
186	Austin Seferian-Jenkins	TE	t
187	Brandon McManus	K	t
188	Washington	DST	t
189	Quincy Enunwa	WR	t
190	Phillip Dorsett	WR	t
191	Eli Manning	QB	t
192	Houston	DST	t
\.
...
SELECT pg_catalog.setval('public.players_player_id_seq', 192, true);
...
SELECT pg_catalog.setval('public.players_playerweek_id_seq', 280, true);
...
SELECT pg_catalog.setval('public.teams_lineup_id_seq', 18, true);
